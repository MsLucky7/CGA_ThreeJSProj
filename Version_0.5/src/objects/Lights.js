class Lights {
    ...
    createDirectionalLight(posX, posY, posZ) {
        var directionaLight = new THREE.DirectionalLight(0xD469FF);
        ...
        directionaLight.shadow.camera.top = 800;
        directionaLight.shadow.camera.bottom = -800;
        directionaLight.shadow.camera.left = -1000;
        directionaLight.shadow.camera.right = 1000;
